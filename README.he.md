...
1. הורד את קובץ ה-**App** מסוג `.exe` מ-[הגרסה האחרונה](https://github.com/itielbru/gphotos-takeout-organizer/releases/latest) — Windows x64. זהו קובץ יחיד עצמאי — בלי ZIP ובלי התקנה.
