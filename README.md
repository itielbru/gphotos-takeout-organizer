...
> XAML/WindowsAppSDK dependency, so single-file publishing works fine for it. The installer
> sidesteps the issue entirely by installing the app folder for you.
